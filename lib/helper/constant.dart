...
class AppAssets {
  ...
  static final String baseUrl = 'http://192.168.1.7:7000/api/v1.0.0/users/';//192.168.1.7     192.168.0.59
  static final String UrlV = 'http://192.168.1.7:7000/api/v1.0.0/';//192.168.1.7        192.168.0.59
  static final String UrlApi = 'http://192.168.1.7:7000/api/';//192.168.1.7         192.168.0.59
